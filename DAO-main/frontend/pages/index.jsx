...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Brahmaputra DAO</title>
        <meta name="description" content="Brahmaputra DAO" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Brahmaputra!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Brahmaputra NFT Balance: {nftBalance}
            <br />
